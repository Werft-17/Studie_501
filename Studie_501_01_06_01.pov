...
#declare x_Scale = 0.05;
#declare x_Between = 0.01;
#for(i, 1, 5)
	#for(k, 1, 6)
		object{
			/*
	...
	/// ####1
	#if( cc= 1 )
    texture{ T_Stone1 scale x_Scale }
#end
#if( cc= 2 )
    texture{ T_Stone2 scale x_Scale }
#end
#if( cc= 3 )
    texture{ T_Stone3 scale x_Scale }
#end
#if( cc= 4 )
    texture{ T_Stone4 scale x_Scale }
#end
#if( cc= 5 )
    texture{ T_Stone5 scale x_Scale }
#end
#if( cc= 6 )
    texture{ T_Stone6 scale x_Scale }
#end
#if( cc= 7 )
    texture{ T_Stone7 scale x_Scale }
#end
#if( cc= 8 )
    texture{ T_Stone8 scale x_Scale }
#end
#if( cc= 9 )
    texture{ T_Stone9 scale x_Scale }
#end
#if( cc= 10 )
    texture{ T_Stone10 scale x_Scale }
#end
#if( cc= 11 )
    texture{ T_Stone11 scale x_Scale }
#end
#if( cc= 12 )
    texture{ T_Stone12 scale x_Scale }
#end
#if( cc= 13 )
    texture{ T_Stone13 scale x_Scale }
#end
#if( cc= 14 )
    texture{ T_Stone14 scale x_Scale }
#end
#if( cc= 15 )
    texture{ T_Stone15 scale x_Scale }
#end
#if( cc= 16 )
    texture{ T_Stone16 scale x_Scale }
#end
#if( cc= 17 )
    texture{ T_Stone17 scale x_Scale }
#end
#if( cc= 18 )
    texture{ T_Stone18 scale x_Scale }
#end
#if( cc= 19 )
    texture{ T_Stone19 scale x_Scale }
#end
#if( cc= 20 )
    texture{ T_Stone20 scale x_Scale }
#end
#if( cc= 21 )
    texture{ T_Stone21 scale x_Scale }
#end
#if( cc= 22 )
    texture{ T_Stone22 scale x_Scale }
#end
#if( cc= 23 )
    texture{ T_Stone23 scale x_Scale }
#end
#if( cc= 24 )
    texture{ T_Stone24 scale x_Scale }
#end
#if( cc= 25 )
    texture{ T_Stone25 scale x_Scale }
#end
#if( cc= 26 )
    texture{ T_Stone26 scale x_Scale }
#end
#if( cc= 27 )
    texture{ T_Stone27 scale x_Scale }
#end
#if( cc= 28 )
    texture{ T_Stone28 scale x_Scale }
#end
#if( cc= 29 )
    texture{ T_Stone29 scale x_Scale }
#end
#if( cc= 30 )
    texture{ T_Stone30 scale x_Scale }
#end
#if( cc= 31 )
    texture{ T_Stone31 scale x_Scale }
#end
#if( cc= 32 )
    texture{ T_Stone32 scale x_Scale }
#end
/// ###		
