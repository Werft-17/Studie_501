...
//	@date		2020-06-02
//
// https://de.wikibooks.org/wiki/Raytracing_mit_POV-Ray:_Variablen,_Schleifen_und_Makros
...
object {
	...
	normal { bumps 0.10 scale 0.01 rotate x*30}
	rotate < -45, -0.2, 0 >
	translate < 0, Gruppe_y, 0.5 >
}

object {
	SechsKantSchraubenMutter( 1, 0.28)
	material { 
		aldusAnakin
		//texture { T_Silver_4D }
		scale 0.4
...
color_map {
	...
	[ 0.30000 rgbf < 0.99831, 0.91583, 0.61589, 0.50000> ]
	[ 0.60000 rgbf < 0.58188, 0.44625, 0.33377, 0.00000> ]
	[ 1.00000 rgbf < 0.83431, 0.62838, 0.21039, 0.50000> ]
}

//cubic_wave
turbulence 5 // <0.0, 0.0, 0.0>
//octaves 0.5
rotate <0.0, 0.0, 0.0>
scale 0.15
//frequency 23.2
//}
	...
	normal { bumps 0.1 scale 0.01 rotate x*45}
	rotate < -45, -20, 0 >
	translate < 1.2, Gruppe_y+0.1, -0.5>
}
